...
public class ConntectFourController {
    ...
    public ConnectFourBoard getGameById(@PathVariable Integer gameId) throws InvalidGameIdException, NullGameIdException {
    ...
    public ConnectFourBoard makeMove(@PathVariable Integer gameId, @PathVariable Integer location) throws InvalidGameIdException, ColunmOutOfBoundsException, NullGameIdException, NullColumnException {
